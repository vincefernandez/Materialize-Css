    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTry"
                aria-expanded="true" aria-controls="collapseTry">
                <i class="fas fa-fw fa-user-alt"></i>
                <span>Profile</span>
            </a>
            <div id="collapseTry" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                      ...
                      <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <div class="dropdown no-arrow">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in"
                                            ...
                                            <a class="dropdown-item" href="#" onclick="editProfile()">Edit</a>
                                ...
                                */ -->
                                ...
                                <input type="text" id="FullName" name="FullName" value="<?php $student->getFullName();?>">
                                </div>
                                </form>
