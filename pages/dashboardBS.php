            ...
            <li class="nav-item active">
                ...
                <div id="Profile" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="cards.html">Informations</a>
                    </div>
                </div>
            </li>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Tuition Fee</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">Still on going</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">Still on going</div>
                                                </div>
                    ...
                    <div class="row">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <form action="dashboardBS.php" method="post">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="TextArea" name="TextArea" rows="13" placeholder="Enter Text Here to Introduce yourself" readonly="true"><?php $student->bio(); ?></textarea>


                                        <button type="submit" class="btn btn-primary btn-small" name="save">Save</button>Date Submitted: <?php $student->bioDate(); ?>
                                    </div>
                                </form>
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form action="dashboardBS.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="py-3 d-flex flex-row align-items-center justify-content-end">
                                            <div class="dropdown no-arrow">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
                                                    <!-- <div class="dropdown-header">Upload Your Picture Here</div> -->
                                                    <input type="file" name="file" id="fileToUpload">
                                                    <button type="submit" name="imageUpload" id='button'>Upload Image</button>

                                                </div>
                                            </div>
                                        </div>
                                        <?php $student->UploadImage() ?>
                                        <!-- <input type="file" name="file" id="fileToUpload">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-info ">Schedule</h6>
                                </div>
                                <div class="card-body">
                ...
                <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>Copyright &copy; Quezon City University</span>
